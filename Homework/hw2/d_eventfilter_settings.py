...
class Window(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.ui = Ui_Form()
        self.ui.setupUi(self)
        self.unite_number = int(settings.value('lcdnumber'))
        self.ui.dial.setValue(self.unite_number)
        self.ui.horizontalSlider.setValue(self.unite_number)
        self.ui.lcdNumber.display(self.unite_number)
        self.comboBox_load = settings.value('combobox')
        self.ui.comboBox.setCurrentText(self.comboBox_load)
        self.comboBoxChoice()
        self.initSignals()
    ...
    def closeEvent(self, event: QCloseEvent) -> None:
        settings.setValue('combobox', self.ui.comboBox.currentText())
        settings.setValue('lcdnumber', self.ui.lcdNumber.value())
