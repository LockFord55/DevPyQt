...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox.addItem('Система счисления')
        self.comboBox.addItem('Двоичная')
        self.comboBox.addItem('Восьмеричная')
        self.comboBox.addItem('Десятичная')
        self.comboBox.addItem('Шестнадцатеричная')
